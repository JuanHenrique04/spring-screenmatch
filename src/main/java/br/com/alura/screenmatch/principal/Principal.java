        ...
        while (opcao != 0) {
            ...
            switch (opcao) {
                ...
                case 10:
                    ...
                    break;
                case 11:
                    buscarEpissodiosDepoisDeUmaData();
                case 0:
...
//        DadosSerie dadosSerie = getDadosSerie();
    ...
    private void buscarPorMaxTempEMinAval() {
        ...
        List<Serie> seriesEncontradas = repositorio.seriesPorTemporadaEAvaliacao(maxTemp, minAval);
    ...
    private void buscarEpisodioPorTrecho(){
        System.out.println("Trecho do nome do episodio: ");
        var trechoEp = leitura.nextLine();
        List<Episodio> episodiosEcontrados = repositorio.episodiosPorTrecho(trechoEp);
    ...
    private void buscarEpissodiosDepoisDeUmaData(){
        buscarSeriePorTitulo();
        if (serieBusca.isPresent()){
            Serie serie = serieBusca.get();
            System.out.println("Ano limite de lançamento");
            var anoLancamento = leitura.nextLine();

            List<Episodio> episodiosAno = repositorio.espisodioPorSerieEAno(serie, anoLancamento);
